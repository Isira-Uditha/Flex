...
<head>
    ...
    <title>Equpipment Count In Category Report</title>
    <style>
        * {
            font-size: 21px;
        ...
        * {
        ...
        #equipment_table th, #equipment_table tr td  {
            border: 1px groove black;
            padding-top: 4px;
            padding-bottom: 4px;
            text-align: center;
        }
        #equipment_table tr:nth-child(even){background-color: #63a1b94d;}
    </style>
</head>
    <body>
        ...
        <div  class="center content" style="margin-top:3%;  border: 1px solid white">
            <table width="100%" id="equipment_table">
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach ($data as $res)
                        <tr>
                            <td scope="col">{{$res->category}}</td>
                            <td scope="col" >{{$res->equipment_count}}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
